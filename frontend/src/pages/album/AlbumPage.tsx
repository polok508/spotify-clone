                    ...
                    <div className="px-6">
                        <div className="space-y-2 py-4">
                            ...
                            {currentAlbum?.songs.map((song, index) => {
                                ...
                                return (
                                <div key={song._id} onClick={() => handlePlaySong(index)} className={"grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-4 py-2 text-sm text-zinc-400 hover:bg-white/5 rouded-md group cursor-pointer"}>
